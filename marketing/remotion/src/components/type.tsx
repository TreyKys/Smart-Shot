...
// The whole look lives here: a tiny uppercase letter-spaced eyebrow over a
// big, tight, sentence-case headline. Everything springs up a few px and
// fades — restrained, never bouncy.
